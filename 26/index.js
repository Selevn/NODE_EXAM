...
connection.connect().then(() => {
    ...
    request
        ...
        .input('a_tn',mssql.NVarChar, 'Уже не лаба техарта')
        .query("update dbo.Auditorium_type set auditorium_typename=@a_tn where auditorium_type=@a_t")
        .then((recordSet) => {
            console.log("Success:",recordSet.rowsAffected[0], 'rows were updated');
            connection.close();
